...
def _arduino_emit(*, surface: dict | None = None, layout: dict | None = None, params: dict) -> str:
    ...
    return f"""// Generated by Modulo (Era: 1980s pulse yellow)
#include <FastLED.h>
...
def register_pulse_yellow_1980s():
    return register(
        BehaviorDef(
            "pulse_yellow_1980s",
            title="1980s Pulse (Yellow)",
            uses=[],
