...
from behaviors.effects.ca_module import register_ca_module
from behaviors.effects.kernel_dsl import register_kernel_dsl
...
# Phase A+E (New Era) showcases
from behaviors.effects.boids_swarm import register_boids_swarm
from behaviors.effects.predator_prey import register_predator_prey
from behaviors.effects.memory_heatmap import register_memory_heatmap
from behaviors.effects.ambient_dashboard import register_ambient_dashboard
...
def register_all():
    ...
    register_predator_prey()
    register_memory_heatmap()
    register_ambient_dashboard()
    register_fsm_phases()
