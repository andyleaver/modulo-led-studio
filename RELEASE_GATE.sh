...
echo
echo "2.1) Lint: deprecated schema aliases must not survive normalization"
python3 tools/lint_legacy_schema.py
python3 tools/lint_legacy_identifiers.py
...
echo
echo "2.55) Resolver inspector"
python3 tools/resolver_inspector.py || true
