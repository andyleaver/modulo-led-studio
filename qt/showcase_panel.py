...
class ShowcasePanel(QtWidgets.QWidget):
    ...
    def _load_selected(self):
        ...
        # Ensure showcase loads under the unlocked "Now" gates.
        # Otherwise a showcase dict without ui.era_complete/era_id will be treated as
        # era_1962_red (default) and get hard-blocked by the era enforcement layer.
        try:
