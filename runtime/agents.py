...
def steer_seek(world: AgentWorld, agent: Agent, target_xy: Tuple[float, float], *, weight: float = 1.0) -> Tuple[float, float]:
    e = agent.ent
...
def steer_flee(world: AgentWorld, agent: Agent, threat_xy: Tuple[float, float], *, weight: float = 1.0) -> Tuple[float, float]:
