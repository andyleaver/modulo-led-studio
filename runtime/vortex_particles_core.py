...
from runtime.shader_math import clamp01, hsv_to_rgb, gauss
from runtime.vector_fields import VortexField, VortexFieldConfig

def vortex_particles_strip(
    *,
    num_leds: int,
    params: dict,
    t: float
    ...
    Kept compatible with the established effect visuals, but moved out of effect code.
    """
